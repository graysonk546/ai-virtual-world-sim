...
public class Car implements Vehicle {
    ...
    private static final int MAXIMUM_COOLDOWN = 6;
    private static final int MAXIMUM_TURNING_SPEED = 4;
    private static final int TURN_CHANCE = 10;
    private static final int MINIMUM_COOLDOWN = 2;
    private static final int STRENGTH_MULTIPLIER = 4200; //[800-2100]
    private static final int DANGEROUS_SPEED = 3;
    ...
    Abstraction Function:
        Car is represented by the cooldown, truckImage, strength.
