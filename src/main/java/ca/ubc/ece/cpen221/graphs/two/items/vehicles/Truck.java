...
public class Truck implements Vehicle{
    ...
    private static final int MAXIMUM_COOLDOWN = 7;
    private static final int MAXIMUM_TURNING_SPEED = 6;
    private static final int TURN_CHANCE = 20;
    private static final int MINIMUM_COOLDOWN = 2;
    private static final int STRENGTH_MULTIPLIER = 14700; //[2100, 7350]
    ...
    Abstraction Function:
        Truck is represented by the cooldown, truckImage, strength.
